 ...
 , trigger: 'on press'
        ...
        (...args: any) => <Elements.Screen3 pass={{
          ...
          (...args:any) => <Elements.DynView pass={{
            ...
            styles:[`{ backgroundColor: "orange", width: "100%", minHeight: 30, flexDirection: "row" }`],
        ...
        , 
          ...
          (...args:any) => <Elements.DynView pass={{
            ...
            styles:[`{ width: '100%', height: 40, backgroundColor: "red" }`],
        ...
        , 
          ...
          (...args:any) => <Elements.DynView pass={{
            ...
            styles:[`{ width: 10, height: 10, backgroundColor: "blue" }`],
